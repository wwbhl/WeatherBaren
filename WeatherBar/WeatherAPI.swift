...
class WeatherAPI {
    let API_KEY = "e847eb3ef3b7c01883912d77994cca6b"
    let BASE_URL = "http://api.openweathermap.org/data/2.5/weather"//forecast"//weather"
    ...
    func weatherFromJSONData(_ data: Data) -> Weather? {
        ...
        NSLog("currentTemp: \(mainDict["temp"])")
        
        let weather = Weather(
            city: json["name"] as! String,
            currentTemp: ((mainDict["temp"])?.floatValue)!,
